...
export function AboutDialog({ open, onClose, formattedDate }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white dark:bg-gray-900 rounded-2xl shadow-2xl max-w-lg w-full mx-4 max-h-[85vh] flex flex-col">
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 dark:border-gray-800">
          <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100">About GCP Instances</h2>
        ...
        <div className="overflow-auto flex-1 px-6 py-5 space-y-4 text-sm text-gray-600 dark:text-gray-300">
          <p>
          ...
          <div>
            <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">Why?</h3>
            <p>
          ...
          <div>
            <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">Who?</h3>
            <p>
          ...
          {formattedDate && (
            <p className="text-gray-500 dark:text-gray-400">
              Pricing last updated: <span className="font-medium text-gray-700 dark:text-gray-200">{formattedDate}</span>
            </p>
          )}
          <p>
            Found an issue?{' '}
